                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="info-box bg-content col-md ">
                                            ...
                                            <div class="info-box-content" ng-controller="indexController">
                                                <span class="info-box-text"></span>
                                                <span class="info-box-number counter" id="global1" >1789325</span>
                                            </div>
                                            <!-- /.info-box-content -->
                                        </div>
                                    </td>
                                    <td>
                                        <div class="info-box bg-content col-md ">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text"></span>
                                                <span class="info-box-number counter" id="global2">8</span>
                                            </div>
                                            <!-- /.info-box-content -->
                                        </div>
                                    </td>
                                    <td>
                                        <div class="info-box bg-content col-md ">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text"></span>
                                                <span class="info-box-number counter" id="global3">264500</span><span class="badge style_bg text-white"> FCFA</span>
                                            </div>
                                            <!-- /.info-box-content -->
                                        </div>
                                    </td>
                                    <td>
                                        <div class="info-box bg-content col-md ">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text"></span>
                                                <span class="info-box-number counter" id="global4">166620</span><span class="badge style_bg text-white"> FCFA</span>
                                            </div>
                                            <!-- /.info-box-content -->
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="info-box bg-content col-md ">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text"></span>
                                                <span class="info-box-number counter" id="month1">6</span>
                                            </div>
                                            <!-- /.info-box-content -->
                                        </div>
                                    </td>
                                    <td>
                                        <div class="info-box bg-content col-md ">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text"></span>
                                                <span class="info-box-number counter" id="month2">0</span>
                                            </div>
                                            <!-- /.info-box-content -->
                                        </div>
                                    </td>
                                    <td>
                                        <div class="info-box bg-content col-md ">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text"></span>
                                                <span class="counter info-box-number" id="month3">30000.3</span><span class="badge style_bg text-white"> FCFA</span>
                                            </div>
                                            <!-- /.info-box-content -->
                                        </div>
                                    </td>
                                    <td>
                                        <div class="info-box bg-content col-md ">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text"></span>
                                                <span class="counter info-box-number" id="month4">25100</span><span class="badge style_bg text-white"> FCFA</span>
                                            </div>
                                            <!-- /.info-box-content -->
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="info-box bg-content col-md ">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text"></span>
                                                <span class="info-box-number counter" id="day1">0</span>
                                            </div>
                                            <!-- /.info-box-content -->
                                        </div>
                                    </td>
                                    <td>
                                        <div class="info-box bg-content col-md ">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text"></span>
                                                <span class="info-box-number counter" id="day2">0</span>
                                            </div>
                                            <!-- /.info-box-content -->
                                        </div>
                                    </td>
                                    <td>
                                        <div class="info-box bg-content col-md ">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text"></span>
                                                <span class="info-box-number counter" id="day3">0</span><span class="badge style_bg text-white"> FCFA</span>
                                            </div>
                                            <!-- /.info-box-content -->
                                        </div>
                                    </td>
                                    <td>
                                        <div class="info-box bg-content col-md ">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text"></span>
                                                <span class="info-box-number counter" id="day4">0</span><span class="badge style_bg text-white"> FCFA</span>
                                            </div>
                                            <!-- /.info-box-content -->
                                        </div>
                                    </td>
