            ...
            <div class="mt-5 bg-white py-1 border-bottom">
                <div class="container-fluid">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <h5 class="flex-fill">Statistiques d'<span class="text-success">aujourd'hui</span></h5>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-light">
            <div class="container-fluid">
                <div class="row align-items-center justify-content-center">
                    <!-- Info Boxes Style 2 -->
                    <div class="info-box bg-light col-md-8 marge">
                        <div class="info-box-content form-group justify-content-between">
                            <div class="row container" style="margin: auto;">
                                <input id="ifu" name="ifu" placeholder="Rapport Machine" type="text" autocomplete="off" class="form-control style_form_control col-sm-10" value=""/>
                                <button class="btn btn-block btn-danger form-control col-sm-1 justify-content-center" style="margin: auto;"><i class="fas fa-filter"></i></button>
                            </div>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered">
                                <thead class="border-bottom">
                                    <tr>
                                        <th scope="col">N°</th>
                                        <th scope="col">Rapport Machine</th>
                                        <th scope="col">Machine Active</th>
                                        <th scope="col">Données Reçues</th>
                                        <th scope="col">Données Envoyées</th>
                                        <th scope="col">Remboursement Reçus</th>
                                        <th scope="col">Vente Reçus</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
