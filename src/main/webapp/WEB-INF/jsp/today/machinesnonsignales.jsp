        ...
        <div class="mt-5 bg-white py-1 border-bottom">
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center mb-1">
                    <h5 class="flex-fill">Machines <span class="text-success">non</span> Signalés</h5>
                </div>
            </div>
        </div>
        <div class="bg-light">
            <div class="container-fluid">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="info-box bg-title col-md-5 marge">
                        <div class="info-box-content">
                            <div class="col-sm-12 form-group">
                                <input id="name" name="ifu" placeholder="Nom Propriétaire" type="text" class="form-control style_form_control" autocomplete="off" value=""/>
                            </div>
                    ...
                    <div class="info-box bg-content col-md-5 marge">
                        <div class="info-box-content">
                            <div class="col-sm-12 form-group">
                                <input id="sim" name="ifu" placeholder="Numéro SIM" type="text" class="form-control style_form_control" autocomplete="off" value=""/>
                            </div>
                            <div class="col-sm-3 form-group">
                                <button class="btn btn-block btn-danger mt-3"><i class="fas fa-filter"></i>Filtrer</button>
                            </div>
