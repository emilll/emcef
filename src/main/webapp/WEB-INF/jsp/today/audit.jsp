        ...
        <div class="mt-5 bg-white py-1 border-bottom">
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center mb-1">
                    <h5 class="flex-fill">Journal <span class="text-success">d'audit</span></h5>
                </div>
            </div>
        </div>
        <div class="bg-light">
            <div class="container-fluid">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="info-box bg-title col-md-5 marge">
                        <div class="info-box-content">
                            <div class="col-sm-12 form-group">
                                <input id="ifu" name="ifu" placeholder="Adresse IP" type="text" class="form-control style_form_control" value=""/>
                            </div>
                    ...
                    <div class="info-box bg-content col-md-5 marge">
                        <div class="info-box-content">
                            <div class="col-sm-12 form-group">
                                <input id="ifu" name="ifu" placeholder="NIM" type="text" class="form-control style_form_control" value=""/>
                            </div>
                            <div class="col-sm-3 form-group">
                                <button class="btn btn-block btn-danger mt-3"><i class="fas fa-filter"></i>Filtrer</button>
                            </div>
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>
                                            <span class="text-dark">123456789</span>
                                            
                                        </td>
                                        <td>
                                            <span>192.168.12.6</span>
                                        </td>
                                        <td>
