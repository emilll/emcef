            ...
            <div class="mt-5 bg-white py-1 border-bottom">
                <div class="container-fluid">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <h5 class="flex-fill">Factures d'<span class="text-success">aujourd'hui</span></h5>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="info-box bg-content col-md-5 marge">
                        <div class="info-box-content">
                            <div class="col-sm-12 form-group">
                                <input id="ifu" name="ifu" placeholder="IFU Client" type="text" class="form-control style_form_control" autocomplete="off" value=""/>
                            </div>
                            <div class="col-sm-3 form-group">
                                <button class="btn btn-block btn-danger mt-3"><i class="fas fa-filter"></i>Filtrer</button>
                            </div>
