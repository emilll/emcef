...
<html lang="fr">
    <head>
        ...
        <link rel="stylesheet" href="${contextPath}/assets/css/all.min.css">
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="py-5 mt-5" style="background-image: url('${contextPath}/assets/img/regloplan.png');">
                <div class="container">
                    <div class="row aos-init aos-animate" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="700" data-aos-delay="100">
                        <div class="col-sm-6 my-auto">
                            <form class="mb-2" action="${contextPath}/login" method="post">
                        ...
                        <div class="col-sm-6 my-auto">
                            <img src="${contextPath}/assets/img/facture_print.png" loading="lazy" class="img-fluid" alt="facture_print.png">
                        </div>
                    </div>
                </div>
            </div>
