...
<body>
  <section id="container">
   <!--main content start-->
    <section id="">
      <section class="">
        <h3><i class="fa fa-angle-right"></i> Modification des informations d'un employé</h3>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="col-md-offset-1 content-panel col-md-10 col-md-offset-1">
              ...
              <form class="form-horizontal style-form" method="post" action="/save" modelAttribute="employee">
                  <input type="hidden" name="ID" value="<c:out value='${employee.ID}'/>">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label" name="firstname">Prénom (s)</label>
                  <div class="col-sm-10">
                      <input type="text" class="form-control round-form" name="firstname" value="<c:out value='${employee.firstname}'/>">
                  </div>
                </div>
                  <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label" name="lastname">Nom</label>
                  <div class="col-sm-10">
                      <input type="text" class="form-control round-form" name="lastname" value="<c:out value='${employee.lastname}'/>">
                  </div>
                </div>
                  <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label" name="email" >E-mail</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control round-form" name="email" value="<c:out value='${employee.email}'/>">
                  </div>
                </div>
